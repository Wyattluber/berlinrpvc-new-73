...
const PartnershipDetails = ({ partnerServer, isActivePartnership, onClose }: PartnershipDetailsProps) => {
  ...
  return (
    <div className="mt-4 pt-4 border-t border-gray-200 relative max-h-[80vh] overflow-hidden">
      ...
      {isMobile && (
        <div className="mt-6 mb-4 text-center sticky bottom-0 bg-white pb-2 pt-2">
