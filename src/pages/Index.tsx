    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow mt-0 z-10">
        ...
        <section className="bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 text-white py-20 relative overflow-hidden">
          <div className="container mx-auto px-4 text-center relative z-[1]">
            <img 
              ...
              alt="BerlinRP-VC"
              className="w-full max-h-64 object-contain mx-auto drop-shadow-[0_0_15px_rgba(59,130,246,0.5)]"
            />
        ...
        <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold mb-10 text-center text-gray-800">Unser Team</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {/* Founder */}
              <div className="flex items-center gap-4 bg-[#2f3136] p-4 rounded-lg shadow-md text-white">
                <img src="https://cdn.discordapp.com/avatars/1150411455443783795/4255ccaf55b3d9ecdddcabe4e6d53fc5?size=1024" alt="Founder" className="w-16 h-16 rounded-full" />
                <div>
                  <p className="text-sm text-gray-400">Rang: Founder</p>
                  <h3 className="text-lg font-semibold">◤✞𝕯𝖆𝖗𝖐 𝕬𝖓𝖌𝖊𝖑✞◥</h3>
                </div>
              </div>

              {/* Co-Founder */}
              <div className="flex items-center gap-4 bg-[#2f3136] p-4 rounded-lg shadow-md text-white">
                <img src="https://cdn.discordapp.com/avatars/1020320597936439429/0328f839138b450d1029f2c582f4f4e0?size=1024" alt="Co-Founder" className="w-16 h-16 rounded-full" />
                <div>
                  <p className="text-sm text-gray-400">Rang: Co-Founder</p>
                  <h3 className="text-lg font-semibold">Backtrix_23 | Berlin RP-VC</h3>
                </div>
              </div>
            </div>
            {/* Erweiterbare Teams: Teamleiter, Moderatoren usw. */}
          </div>
        </section>
